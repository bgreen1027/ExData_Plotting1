...
globalReactivePower <- as.numeric(subSetExDataWk1$Global_reactive_power)
voltage <- as.numeric(subSetExDataWk1$Voltage)
subMetering1 <- as.numeric(subSetExDataWk1$Sub_metering_1)
subMetering2 <- as.numeric(subSetExDataWk1$Sub_metering_2)
subMetering3 <- as.numeric(subSetExDataWk1$Sub_metering_3)
